...
/**
 * Provides the local service interface for mencobatutorial. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author liferay
 * @see mencobatutorialLocalServiceUtil
...
public interface mencobatutorialLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link mencobatutorialLocalServiceUtil} to access the mencobatutorial local service. Add custom service methods to {@link mencobatutorialservice.service.impl.mencobatutorialLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<mencobatutorial> getGuestbooks(long groupId, int start,
		int end, OrderByComparator<mencobatutorial> obc);
