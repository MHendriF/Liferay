...
public interface mencobatutorialPersistence extends BasePersistence<mencobatutorial> {
	...
	* @return the matching mencobatutorials
	*/
	public java.util.List<mencobatutorial> findByUuid_C(String uuid,
		long companyId);
	...
	*/
	public java.util.List<mencobatutorial> filterFindByGroupId(long groupId);
	...
	* @return the matching mencobatutorials that the user has permission to view
	*/
	public java.util.List<mencobatutorial> filterFindByG_S(long groupId,
		int status);
