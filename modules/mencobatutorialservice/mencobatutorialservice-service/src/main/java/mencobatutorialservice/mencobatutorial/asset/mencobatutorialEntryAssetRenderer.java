...
public class mencobatutorialEntryAssetRenderer extends BaseJSPAssetRenderer<mencobatutorialEntry> {

	  public mencobatutorialEntryAssetRenderer(mencobatutorialEntry entry) {
...
//	  }
	  ...
	  @Override
	  public mencobatutorialEntry getAssetObject() {
	    return _entry;
	  }
	  ...
	  public String getURLViewInContext(LiferayPortletRequest liferayPortletRequest,
	    ...
	    try {
	      ...
	      portletURL.setParameter("mvcRenderCommandName", "/mencobatutorialportlet/view");
	      portletURL.setParameter("entryId", String.valueOf(_entry.getEntryId()));
	  ...
	  private mencobatutorialEntry _entry;
}
