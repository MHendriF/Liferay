...
import mencobatutorialservice.exception.NoSuchmencobatutorialEntryException;

import mencobatutorialservice.model.impl.mencobatutorialEntryImpl;
import mencobatutorialservice.model.impl.mencobatutorialEntryModelImpl;
 ...
 * @see mencobatutorialservice.service.persistence.mencobatutorialEntryUtil
 * @generated
 */
@ProviderType
public class mencobatutorialEntryPersistenceImpl extends BasePersistenceImpl<mencobatutorialEntry>
	 ...
	 */
	@Override
	public List<mencobatutorialEntry> filterFindByG_G(long groupId,
		long guestbookId) {
	...
	public List<mencobatutorialEntry> filterFindByG_G(long groupId,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_MENCOBATUTORIALENTRY_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_MENCOBATUTORIALENTRY_NO_INLINE_DISTINCT_WHERE_1);
		}
		...
		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_MENCOBATUTORIALENTRY_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(mencobatutorialEntryModelImpl.ORDER_BY_SQL);
			}
		}
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, mencobatutorialEntryImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, mencobatutorialEntryImpl.class);
			}
			...
			return (List<mencobatutorialEntry>)QueryUtil.list(q, getDialect(),
				start, end);
		}
		catch (Exception e) {
			throw processException(e);
	...
	public mencobatutorialEntry[] filterFindByG_G_PrevAndNext(long entryId,
		...
		try {
			...
			array[0] = filterGetByG_G_PrevAndNext(session,
					mencobatutorialEntry, groupId, guestbookId,
					orderByComparator, true);

			array[1] = mencobatutorialEntry;

			array[2] = filterGetByG_G_PrevAndNext(session,
					mencobatutorialEntry, groupId, guestbookId,
	...
	protected mencobatutorialEntry filterGetByG_G_PrevAndNext(Session session,
		mencobatutorialEntry mencobatutorialEntry, long groupId,
		long guestbookId,
		OrderByComparator<mencobatutorialEntry> orderByComparator,
		boolean previous) {
	...
	public int filterCountByG_G(long groupId, long guestbookId) {
		...
		query.append(_FILTER_SQL_COUNT_MENCOBATUTORIALENTRY_WHERE);
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_STATUS = new FinderPath(mencobatutorialEntryModelImpl.ENTITY_CACHE_ENABLED,
			mencobatutorialEntryModelImpl.FINDER_CACHE_ENABLED,
			mencobatutorialEntryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_STATUS =
		new FinderPath(mencobatutorialEntryModelImpl.ENTITY_CACHE_ENABLED,
			...
			mencobatutorialEntryModelImpl.STATUS_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_STATUS = new FinderPath(mencobatutorialEntryModelImpl.ENTITY_CACHE_ENABLED,
			mencobatutorialEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<mencobatutorialEntry> findByStatus(int status) {
		return findByStatus(status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the mencobatutorial entries where status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link mencobatutorialEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<mencobatutorialEntry> findByStatus(int status, int start,
		int end) {
		return findByStatus(status, start, end, null);
	}

	/**
	 * Returns an ordered range of all the mencobatutorial entries where status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link mencobatutorialEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<mencobatutorialEntry> findByStatus(int status, int start,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (mencobatutorialEntry mencobatutorialEntry : list) {
					if ((status != mencobatutorialEntry.getStatus())) {
						list = null;
	...
	/**
	 * Returns the first mencobatutorial entry in the ordered set where status = &#63;.
	 *
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching mencobatutorial entry
	 ...
	 */
	@Override
	public mencobatutorialEntry findByStatus_First(int status,
		OrderByComparator<mencobatutorialEntry> orderByComparator)
		throws NoSuchmencobatutorialEntryException {
		mencobatutorialEntry mencobatutorialEntry = fetchByStatus_First(status,
				orderByComparator);
	 ...
	 */
	@Override
	public mencobatutorialEntry fetchByStatus_First(int status,
		OrderByComparator<mencobatutorialEntry> orderByComparator) {
		List<mencobatutorialEntry> list = findByStatus(status, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last mencobatutorial entry in the ordered set where status = &#63;.
	 *
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching mencobatutorial entry
	 ...
	 */
	@Override
	public mencobatutorialEntry findByStatus_Last(int status,
		OrderByComparator<mencobatutorialEntry> orderByComparator)
		throws NoSuchmencobatutorialEntryException {
		mencobatutorialEntry mencobatutorialEntry = fetchByStatus_Last(status,
				orderByComparator);
	 ...
	 */
	@Override
	public mencobatutorialEntry fetchByStatus_Last(int status,
		OrderByComparator<mencobatutorialEntry> orderByComparator) {
		...
		List<mencobatutorialEntry> list = findByStatus(status, count - 1,
	...
	/**
	 * Returns the mencobatutorial entries before and after the current mencobatutorial entry in the ordered set where status = &#63;.
	 *
	 * @param entryId the primary key of the current mencobatutorial entry
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public mencobatutorialEntry[] findByStatus_PrevAndNext(long entryId,
		int status, OrderByComparator<mencobatutorialEntry> orderByComparator)
		throws NoSuchmencobatutorialEntryException {
		mencobatutorialEntry mencobatutorialEntry = findByPrimaryKey(entryId);
		...
		try {
			...
			array[0] = getByStatus_PrevAndNext(session, mencobatutorialEntry,
					status, orderByComparator, true);

			array[1] = mencobatutorialEntry;

			array[2] = getByStatus_PrevAndNext(session, mencobatutorialEntry,
	...
	protected mencobatutorialEntry getByStatus_PrevAndNext(Session session,
		mencobatutorialEntry mencobatutorialEntry, int status,
		OrderByComparator<mencobatutorialEntry> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the mencobatutorial entries where status = &#63; from the database.
	 *
	 * @param status the status
	 */
	@Override
	public void removeByStatus(int status) {
		for (mencobatutorialEntry mencobatutorialEntry : findByStatus(status,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(mencobatutorialEntry);
		}
	}
	...
	/**
	 * Returns the number of mencobatutorial entries where status = &#63;.
	 *
	 * @param status the status
	 * @return the number of matching mencobatutorial entries
	 */
	...
	private static final String _FINDER_COLUMN_STATUS_STATUS_2 = "mencobatutorialEntry.status = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_S = new FinderPath(mencobatutorialEntryModelImpl.ENTITY_CACHE_ENABLED,
			mencobatutorialEntryModelImpl.FINDER_CACHE_ENABLED,
			mencobatutorialEntryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_S = new FinderPath(mencobatutorialEntryModelImpl.ENTITY_CACHE_ENABLED,
			mencobatutorialEntryModelImpl.FINDER_CACHE_ENABLED,
			mencobatutorialEntryImpl.class,
			...
			mencobatutorialEntryModelImpl.GROUPID_COLUMN_BITMASK |
			mencobatutorialEntryModelImpl.STATUS_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_S = new FinderPath(mencobatutorialEntryModelImpl.ENTITY_CACHE_ENABLED,
			mencobatutorialEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_S",
			new String[] { Long.class.getName(), Integer.class.getName() });

	/**
	 * Returns all the mencobatutorial entries where groupId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param status the status
	 * @return the matching mencobatutorial entries
	 */
	@Override
	public List<mencobatutorialEntry> findByG_S(long groupId, int status) {
		return findByG_S(groupId, status, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}

	/**
	 * Returns a range of all the mencobatutorial entries where groupId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link mencobatutorialEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the mencobatutorial entries where groupId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link mencobatutorialEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<mencobatutorialEntry> findByG_S(long groupId, int status,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (mencobatutorialEntry mencobatutorialEntry : list) {
					if ((groupId != mencobatutorialEntry.getGroupId()) ||
							(status != mencobatutorialEntry.getStatus())) {
						list = null;
	...
	/**
	 * Returns the first mencobatutorial entry in the ordered set where groupId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public mencobatutorialEntry findByG_S_First(long groupId, int status,
		OrderByComparator<mencobatutorialEntry> orderByComparator)
		throws NoSuchmencobatutorialEntryException {
		mencobatutorialEntry mencobatutorialEntry = fetchByG_S_First(groupId,
	 ...
	 */
	@Override
	public mencobatutorialEntry fetchByG_S_First(long groupId, int status,
		OrderByComparator<mencobatutorialEntry> orderByComparator) {
		List<mencobatutorialEntry> list = findByG_S(groupId, status, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last mencobatutorial entry in the ordered set where groupId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public mencobatutorialEntry findByG_S_Last(long groupId, int status,
		OrderByComparator<mencobatutorialEntry> orderByComparator)
		throws NoSuchmencobatutorialEntryException {
		mencobatutorialEntry mencobatutorialEntry = fetchByG_S_Last(groupId,
				status, orderByComparator);
	 ...
	 */
	@Override
	public mencobatutorialEntry fetchByG_S_Last(long groupId, int status,
		OrderByComparator<mencobatutorialEntry> orderByComparator) {
		...
		List<mencobatutorialEntry> list = findByG_S(groupId, status, count - 1,
				count, orderByComparator);
	...
	/**
	 * Returns the mencobatutorial entries before and after the current mencobatutorial entry in the ordered set where groupId = &#63; and status = &#63;.
	 *
	 * @param entryId the primary key of the current mencobatutorial entry
	 * @param groupId the group ID
	 * @param status the status
	 ...
	 */
	@Override
	public mencobatutorialEntry[] findByG_S_PrevAndNext(long entryId,
		...
		try {
			...
			array[0] = getByG_S_PrevAndNext(session, mencobatutorialEntry,
					groupId, status, orderByComparator, true);

			array[1] = mencobatutorialEntry;

			array[2] = getByG_S_PrevAndNext(session, mencobatutorialEntry,
	...
	protected mencobatutorialEntry getByG_S_PrevAndNext(Session session,
		mencobatutorialEntry mencobatutorialEntry, long groupId, int status,
		OrderByComparator<mencobatutorialEntry> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<mencobatutorialEntry> filterFindByG_S(long groupId, int status) {
	...
	public mencobatutorialEntry[] filterFindByG_S_PrevAndNext(long entryId,
		...
		try {
			...
			array[0] = filterGetByG_S_PrevAndNext(session,
					mencobatutorialEntry, groupId, status, orderByComparator,
					true);

			array[1] = mencobatutorialEntry;

			array[2] = filterGetByG_S_PrevAndNext(session,
					mencobatutorialEntry, groupId, status, orderByComparator,
					false);
	...
	protected mencobatutorialEntry filterGetByG_S_PrevAndNext(Session session,
		mencobatutorialEntry mencobatutorialEntry, long groupId, int status,
		OrderByComparator<mencobatutorialEntry> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByG_S(long groupId, int status) {
		for (mencobatutorialEntry mencobatutorialEntry : findByG_S(groupId,
	...
	/**
	 * Returns the number of mencobatutorial entries where groupId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param status the status
	 * @return the number of matching mencobatutorial entries
	...
	private static final String _FINDER_COLUMN_G_S_GROUPID_2 = "mencobatutorialEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_S_STATUS_2 = "mencobatutorialEntry.status = ?";
	...
	public mencobatutorialEntry updateImpl(
		...
		if (!mencobatutorialEntryModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] { mencobatutorialEntryModelImpl.getStatus() };
			...
			args = new Object[] {
					mencobatutorialEntryModelImpl.getGroupId(),
					mencobatutorialEntryModelImpl.getStatus()
				};
			...
			if ((mencobatutorialEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						mencobatutorialEntryModelImpl.getOriginalStatus()
					};
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "mencobatutorialEntry.entryId";
	private static final String _FILTER_SQL_SELECT_MENCOBATUTORIALENTRY_WHERE = "SELECT DISTINCT {mencobatutorialEntry.*} FROM GB_mencobatutorialEntry mencobatutorialEntry WHERE ";
	private static final String _FILTER_SQL_SELECT_MENCOBATUTORIALENTRY_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {GB_mencobatutorialEntry.*} FROM (SELECT DISTINCT mencobatutorialEntry.entryId FROM GB_mencobatutorialEntry mencobatutorialEntry WHERE ";
	private static final String _FILTER_SQL_SELECT_MENCOBATUTORIALENTRY_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN GB_mencobatutorialEntry ON TEMP_TABLE.entryId = GB_mencobatutorialEntry.entryId";
	private static final String _FILTER_SQL_COUNT_MENCOBATUTORIALENTRY_WHERE = "SELECT COUNT(DISTINCT mencobatutorialEntry.entryId) AS COUNT_VALUE FROM GB_mencobatutorialEntry mencobatutorialEntry WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "mencobatutorialEntry";
	private static final String _FILTER_ENTITY_TABLE = "GB_mencobatutorialEntry";
	private static final String _ORDER_BY_ENTITY_ALIAS = "mencobatutorialEntry.";
	private static final String _ORDER_BY_ENTITY_TABLE = "GB_mencobatutorialEntry.";
