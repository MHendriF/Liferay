 ...
 * {@link product.service.impl.ProductLocalServiceImpl} and is the
 ...
 * @see product.service.base.ProductLocalServiceBaseImpl
 * @see product.service.impl.ProductLocalServiceImpl
 * @generated
 */
@ProviderType
public class ProductLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link product.service.impl.ProductLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static product.model.Product addProduct(
	...
	*/
	public static product.model.Product createProduct(long productId) {
	...
	*/
	public static product.model.Product deleteProduct(long productId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	* @return the product that was removed
	*/
	public static product.model.Product deleteProduct(
		product.model.Product product) {
	...
	*/
	...
	public static product.model.Product fetchProduct(long productId) {
	...
	*/
	public static product.model.Product fetchProductByUuidAndCompanyId(
	...
	* @throws PortalException if a product with the primary key could not be found
	*/
	public static product.model.Product getProduct(long productId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getProduct(productId);
	}

	public static java.util.List<product.model.Product> getProductByPrice(
		long price) {
	...
	*/
	public static product.model.Product getProductByUuidAndCompanyId(
		String uuid, long companyId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<product.model.Product> getProducts(int start,
		int end) {
	...
	*/
	...
	public static void saveProduct(String productName, long productPrice) {
		getService().saveProduct(productName, productPrice);
	}
	...
	*/
	public static product.model.Product updateProduct(
		product.model.Product product) {
	...
	static {
		...
		ServiceTracker<ProductLocalService, ProductLocalService> serviceTracker = new ServiceTracker<ProductLocalService, ProductLocalService>(bundle.getBundleContext(),
				ProductLocalService.class, null);
